...
FClassRegistrationInfo Z_Registration_Info_UClass_UDarkerNodesSettings;
UClass* UDarkerNodesSettings::GetPrivateStaticClass()
{
	using TClass = UDarkerNodesSettings;
	if (!Z_Registration_Info_UClass_UDarkerNodesSettings.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("DarkerNodesSettings"),
			Z_Registration_Info_UClass_UDarkerNodesSettings.InnerSingleton,
			StaticRegisterNativesUDarkerNodesSettings,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UDarkerNodesSettings.InnerSingleton;
}
UClass* Z_Construct_UClass_UDarkerNodesSettings_NoRegister()
{
	return UDarkerNodesSettings::GetPrivateStaticClass();
}
...
// ********** Begin Class UDarkerNodesSettings constinit property declarations *********************
...
// ********** End Class UDarkerNodesSettings constinit property declarations ***********************
...
// ********** Begin Class UDarkerNodesSettings Property Definitions ********************************
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UDarkerNodesSettings_Statics::NewProp_Preset = { "Preset", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDarkerNodesSettings, Preset), Z_Construct_UEnum_DarkerNodes_EPresets, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Preset_MetaData), NewProp_Preset_MetaData) }; // 2801842342
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UDarkerNodesSettings_Statics::NewProp_FontSize = { "FontSize", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDarkerNodesSettings, FontSize), Z_Construct_UEnum_DarkerNodes_EFontSize, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FontSize_MetaData), NewProp_FontSize_MetaData) }; // 3865509165
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UDarkerNodesSettings_Statics::NewProp_FontFamily = { "FontFamily", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDarkerNodesSettings, FontFamily), Z_Construct_UEnum_DarkerNodes_EFontFamily, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FontFamily_MetaData), NewProp_FontFamily_MetaData) }; // 3487658530
...
// ********** End Class UDarkerNodesSettings Property Definitions **********************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UDarkerNodesSettings);
UDarkerNodesSettings::~UDarkerNodesSettings() {}
// ********** End Class UDarkerNodesSettings *******************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DarkerNodes_Source_DarkerNodes_Public_DarkerNodesSettings_h__Script_DarkerNodes_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		...
		{ EHeaderStyle_StaticEnum, TEXT("EHeaderStyle"), &Z_Registration_Info_UEnum_EHeaderStyle, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 579625796U) },
		{ EButtonPadding_StaticEnum, TEXT("EButtonPadding"), &Z_Registration_Info_UEnum_EButtonPadding, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 617544369U) },
		{ EButtonBorder_StaticEnum, TEXT("EButtonBorder"), &Z_Registration_Info_UEnum_EButtonBorder, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3650176603U) },
		{ EFontFamily_StaticEnum, TEXT("EFontFamily"), &Z_Registration_Info_UEnum_EFontFamily, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3487658530U) },
		{ EFontSize_StaticEnum, TEXT("EFontSize"), &Z_Registration_Info_UEnum_EFontSize, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3865509165U) },
		{ EBlueprintVarNodeLine_StaticEnum, TEXT("EBlueprintVarNodeLine"), &Z_Registration_Info_UEnum_EBlueprintVarNodeLine, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2267904573U) },
		{ EBlueprintVarNodeStyle_StaticEnum, TEXT("EBlueprintVarNodeStyle"), &Z_Registration_Info_UEnum_EBlueprintVarNodeStyle, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2406807790U) },
		{ EIconStyle_StaticEnum, TEXT("EIconStyle"), &Z_Registration_Info_UEnum_EIconStyle, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3068379023U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDarkerNodesSettings, UDarkerNodesSettings::StaticClass, TEXT("UDarkerNodesSettings"), &Z_Registration_Info_UClass_UDarkerNodesSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDarkerNodesSettings), 759731608U) },
	};
}; // Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DarkerNodes_Source_DarkerNodes_Public_DarkerNodesSettings_h__Script_DarkerNodes_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DarkerNodes_Source_DarkerNodes_Public_DarkerNodesSettings_h__Script_DarkerNodes_735768091{
	TEXT("/Script/DarkerNodes"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DarkerNodes_Source_DarkerNodes_Public_DarkerNodesSettings_h__Script_DarkerNodes_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DarkerNodes_Source_DarkerNodes_Public_DarkerNodesSettings_h__Script_DarkerNodes_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DarkerNodes_Source_DarkerNodes_Public_DarkerNodesSettings_h__Script_DarkerNodes_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DarkerNodes_Source_DarkerNodes_Public_DarkerNodesSettings_h__Script_DarkerNodes_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
