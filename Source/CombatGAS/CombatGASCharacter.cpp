...
void ACombatGASCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACombatGASCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ACombatGASCharacter::Look);
	...
	{
		UE_LOG(LogCombatGAS, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}

void ACombatGASCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACombatGASCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACombatGASCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ACombatGASCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ACombatGASCharacter::DoJumpEnd()
{
